            ...
            <CardContent className="p-6">
              <div className="relative mb-4 overflow-hidden rounded-lg">
                <img 
                  ...
                  onError={(e) => {
                    e.currentTarget.src = "/images/states/default-state.jpg";
                  }}
                />
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-semibold">{state.totalArea}</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-muted-foreground">Total Production:</span>
                  <span className="font-semibold">{state.productionData.totalProduction}</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-muted-foreground">Annual Growth:</span>
                  <span className="font-semibold text-green-600">{state.productionData.annualGrowth}</span>
                </div>
              </div>
